import pytest
from solution import calculate_distance, calculate_force, calculate_net_force_on, calculate_acceleration, update_velocity, update, G
...
def test_calculate_force():
    ...
    assert calculate_force(body1, body2) == (G, 0)
...
def test_calculate_net_force_on():
    ...
    assert calculate_net_force_on(body1, system) == (1.25*G, 0)
...
def test_calculate_acceleration():
    ...
    assert calculate_acceleration(body1, system) == (1.25*G, 0)
